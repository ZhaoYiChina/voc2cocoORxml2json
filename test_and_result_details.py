...
# 创建一个记录检测结果的文件
txt_path = result_path + '/result_doc/result_details.txt'
...
class YOLO(object):
    _defaults = {
        ...
        "model_path": '../logs/000/ep066-loss16.662-val_loss16.540.h5',
...
if __name__ == '__main__':
    ...
    for filename in os.listdir(path):
        ...
        file.write('\n')
        #r_image.show() #显示检测结果
        image_save_path = '../result/result_img/result_' + portion[1]
